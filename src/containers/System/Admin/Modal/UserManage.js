...
class UserManage extends Component {
      ...
      this.setState({
        ...
        previewCertificateImage:
          image === "CERTIFICATEIMAGE"
            ? URL.createObjectURL(file)
            : this.state.previewCertificateImage,
        image: image === "IMAGE" ? base64 : this.state.image,
        certificateImage:
          image === "CERTIFICATEIMAGE" ? base64 : this.state.certificateImage,
      });
    }
  };
      ...
      this.setState({
        ...
        previewCertificateImage:
          image === "CERTIFICATEIMAGE"
            ...
            : this.state.previewCertificateImage,
        certificateImage:
          image === "CERTIFICATEIMAGE" ? "" : this.state.certificateImage,
      });
    }
  };
  ...
  handleEditUserFromParent = (data) => {
    if (this.props.action === CRUD_ACTIONS.EDIT) {
      ...
      if (data.certificateImage) {
        certificateImageBase64 = new Buffer(
  ...
  render() {
    ...
    isShow &&
      document.getElementsByTagName("body")[0].classList.add("showScroll");
    !isShow &&
      document.getElementsByTagName("body")[0].classList.remove("showScroll");
    return (
      <div className="overflow-visible">
        ...
        >
          <ModalHeader
            ...
            className="text-2xl"
          >
            {isVerify === 0 && this.props.userInfo.roleId !== "R1" ? (
              <FormattedMessage id="manage-user.edit-profile" />
            ) : isVerify === 0 ? (
              <FormattedMessage id="manage-user.confirm-user-infomation" />
            ) : action === CRUD_ACTIONS.CREATE ? (
              <FormattedMessage id="manage-user.create-doctor-information" />
            ) : action === CRUD_ACTIONS.EDIT ? (
              <FormattedMessage id="manage-user.edit-doctor-information" />
            ) : (
              ""
            )}
          </ModalHeader>
            ...
            <form id="myForm">
              ...
              <div className="row mb-3 justify-content-center">
                <div className="form-group col-md-3">
                  <label htmlFor="inputNumberPhone4">
                    <FormattedMessage id="manage-user.phoneNumber" />
                  </label>
                  <input
                    type="text"
                    className="form-control"
                    id="inputNumberPhone4"
                    placeholder="0374327109"
                    value={phoneNumber}
              ...
              <div className="row mb-3 justify-content-center">
                <div className="form-group col-md-5">
                  ...
                  <span className="text-red-600">
                    {createNewUserInfo?.errCode === 1
                      ? createNewUserInfo.errMessage
                      : ""}
                  </span>
                </div>
                <div className="form-group col-md-5">
                  ...
                  <div className="form-group col-md-4 mt-2">
                    ...
                    <div className="flex items-center">
                      <select
                        ...
                        className="form-control"
                        value={position}
                        onChange={(e) => this.handleInput(e, "position")}
                      >
              ...
              <div className="flex">
                <div className="mb-4 offset-md-1 ">
                  <label htmlFor="inputImage" className="font-semibold">
                        ...
                        <div className="flex flex-col items-center justify-center w-full pb-2 ">
                          ...
                          <div className="flex w-full justify-around mt-2">
                            ...
                            <input
                              ...
                              onChange={(e) =>
                                this.handleChangeImage(e, "IMAGE")
                              }
                            />
                            <button
                              type="button"
                    ...
                    <div className="form-group col-md-3 -ml-2 flex w-full">
                      <div className="mr-5">
                        <label
                          ...
                          htmlFor="inputImage"
                        >
                          <FormattedMessage id="manage-user.bang-cap" />
                        </label>
                        <div className="w-72">
                          <div className="rounded-lg shadow-xl bg-gray-100 ">
                            <div className="m-4">
                              ...
                              <div className="flex flex-col items-center justify-center w-full pb-2 ">
                                <label
                                  htmlFor="preview-img"
                                  className="flex text-md font-semibold flex-col w-full h-48 border-4 border-dashed hover:bg-gray-100 hover:border-gray-300"
                                >
                                  <p className="w-full text-center text-gray-500 cursor-pointer">
                                    Click here to see image full
                                  </p>
                ...
                <div className="col-md-3">
                  {isVerify === 0 && this.props.userInfo.roleId !== "R3" ? (
                    <div className="flex">
                      <button
                        type="button"
                        className="mr-5 rounded text-white bg-indigo-500 w-40 whitespace-nowrap -ml-2 px-4 py-2 font-bold"
                      ...
                      <button
                        type="button"
                        className="btn rounded text-black bg-yellow-500 w-40 whitespace-nowrap -ml-2 px-4 py-2 font-bold"
                    ...
                    <button
                      className={
                        action === CRUD_ACTIONS.EDIT
                          ? "btn btn-warning w-40 whitespace-nowrap -ml-2 px-4 py-2 font-bold"
