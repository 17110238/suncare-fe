                    ...
                    <div className="max-w-7xl mx-auto">
                        <div className="flex justify-between items-center border-b-2 border-gray-100 py-6 ">
                            <div className="flex items-center justify-center cursor-pointer">
                                ...
                                <div className="flex items-center" onClick={() => this.returnToHome()} >
                                    <img className="h-8 w-auto sm:h-10" src={Logo} alt="Image Doctor" />
                                    <span className="ml-2 text-2xl text-red-600 font-semibold" >SunCare</span>
                                </div>
                            </div>
                            <nav className="md:flex space-x-10 cursor-pointer">
                                <div className="text-base">
                                    <div className="font-bold"><FormattedMessage id="homeheader.speciality" /></div>
                                    <div><FormattedMessage id="homeheader.searchdoctor" /></div>
                                </div>
                                <div className="text-base">
                                    <div className="font-bold"><FormattedMessage id="homeheader.health-facility" /></div>
                                    <div><FormattedMessage id="homeheader.choose-hospital-clinic" /></div>
                                </div>
                                <div className="text-base">
                                    <div className="font-bold"> <FormattedMessage id="homeheader.doctor" /></div>
                                    <div><FormattedMessage id="homeheader.choose-doctor" /></div>
                                </div>
                                <div className="text-base">
                                    <div className="font-bold"><FormattedMessage id="homeheader.fee" /></div>
                            ...
                            <div className="flex items-center">
                                ...
                                {language === 'vi' ? <img className="w-4" src={vi} /> : <img className="w-4  " src={en} />}
                                <select className="outline-none" value={language} onChange={(e) => this.handleChangeLanguage(e)}>
