...
class OnlineMedicalExamination extends Component {
  constructor(props) {
    super(props)
    this.state = {
      arrTopDoctors: [],
  ...
  handleViewDetailDoctor = (doctorId) => {
    ...
    history.push(`/detail-doctor?doctorId=${doctorId}&formality=online`)
  }
      ...
      <div className="bg-gray-200" >
        <div className="h-96 pb-3 pt-3 mx-auto w-10/12">
          <div className="flex items-center justify-between mb-3">
            <div className="font-medium text-2xl ">{language === 'vi' ? 'Khám bệnh trực tuyến' : 'Online medical examination'}</div>
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(OnlineMedicalExamination))
